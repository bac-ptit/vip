...
class productimages : public drogon::HttpController<productimages> {
 public:
  ...
  METHOD_ADD(productimages::Create, "", drogon::Post, "filter::AuthFilter");
  METHOD_ADD(productimages::Update, "/{1}", drogon::Put, "filter::AuthFilter");
  METHOD_ADD(productimages::Delete, "/{1}", drogon::Delete, "filter::AuthFilter");
