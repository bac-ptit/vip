...
class Media
{
  public:
     ...
     */
    explicit Media(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Media(const Json::Value &pJson) noexcept(false);
     ...
     */
    Media(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Media>;
    friend drogon::orm::BaseBuilder<Media, true, true>;
    friend drogon::orm::BaseBuilder<Media, true, false>;
    friend drogon::orm::BaseBuilder<Media, false, true>;
    friend drogon::orm::BaseBuilder<Media, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Media>;
#endif
